...
import org.example.dao.TaskInfoDAO;
...
public class ToDoListAppConsole {
    ...
    private static EntityManagerFactory entityManagerFactory; //Crée l'Entity
    private static TaskDAOImpl taskDAO; //importation
    private static TaskInfoDAO TaskInfo;
    public static void main() {
        ...
        do {
            ...
            System.out.println("5. Ajouter une description à la tâche");
            System.out.println("6. Ajouter une priorité à la tâche");
            System.out.println("7. Ajouter une date d'échance à la tâche");
    ...
    private static void markTaskAsCompleted(Scanner scanner){
        System.out.println("Entrez l'ID de la tâche à terminé : ");
        Long taskId  = scanner.nextLong();
        scanner.nextLine();
